...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "020a6c88-f7f2-41ab-a692-f99d1e65c038",
...
const _lazy_DuD3NA = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_DuD3NA, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_DuD3NA, lazy: true, middleware: false, method: undefined }
];
